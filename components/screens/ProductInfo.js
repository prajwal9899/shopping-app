...
import { Text, View, ScrollView, TouchableOpacity, StatusBar, FlatList, Image, Animated, Dimensions, ToastAndroid } from 'react-native'
        ...
        <View style={{
            ...
            <ScrollView>
                <View style={{
                    ...
                    <FlatList
                        data={products.productImageList ? products.productImageList : null}
                ...
                <View style={{
                    ...
                    <View style={{
                        ...
                        <View style={{
                            ...
                            }}>mohpa,kalmeshwar,nagpur - 441502</Text>
                        </View>
                    ...
                    <View style={{
                        ...
                        <Text style={{
                            ...
                            color: COLOURS.black,
                            marginBottom: 4
                        }}>&#8377;{products.productPrice}.00</Text>
                        <Text style={{

                        }}>Tax Rate 2%~ &#8377; {products.productPrice / 20} (~&#8377;
                        {products.productPrice + products.productPrice /20})
                        </Text>
                    </View>
                </View>
            </ScrollView>
            <View style={{
                ...
                alignItems:'center'
                    ...
                    <TouchableOpacity
                    onPress={() => {
                        products.isAvailable ? addToCart(products.id) : null
                    }}
                     style={{
                        width: '86%',
                        height: '90%',
